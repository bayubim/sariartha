    ...
    <div class="modal-dialog">
        <div class="modal-content rounded border-0 shadow-sm">
            ...
            <div class="modal-body">
                        ...
                        @for ($i = 1; $i <= 5; $i++)
                            <label for="star{{ $i }}" class="mb-0 position-relative">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                                    ...
                                    class="cursor-pointer @if($rating >= $i) text-orange @else text-secondary @endif"
                                    viewBox="0 0 20 20">
                                    <path
                ...
                <div class="d-flex justify-content-center mt-3">
                    <textarea class="form-control @error('review') is-invalid @enderror"
                        placeholder="Tulis ulasan disini..." rows="3" wire:model="review"></textarea>
                </div>
                @error('review')
                    <div class="alert alert-danger mt-2 rounded border-0">
                        {{ $message }}
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="storeRating" class="btn btn-primary rounded border-0 shadow-sm"
