                    ...
                    <div class="card-body">
                        <h6>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-geo-alt mb-1" viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="card rounded shadow-sm border-0 mb-5">
                        <div class="card-body">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="inlineRadio1"
                                    wire:click="changeCourier('jne')">
                                <label class="form-check-label" for="inlineRadio1">JNE</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="inlineRadio2"
                                    wire:click="changeCourier('pos')">
                                <label class="form-check-label" for="inlineRadio2">POS</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="inlineRadio3"
                                    ...
                                    @foreach($costs ?? [] as $cost)
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label font-weight-normal me-2">
                                                ...
                                                <span class="ms-1">{{ $cost['service'] }} - Rp
                                                    {{ number_format($cost['cost'][0]['value'], 0, ',', '.') }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        @if($selectCost > 0)
                            ...
                            <livewire:web.checkout.btn-checkout key="{{ now() }}" :province_id="$province_id"
                                :city_id="$city_id" :address="$address" :grandTotal="$grandTotal"
                                :totalWeight="$totalWeight" :selectCourier="$selectCourier" :selectService="$selectService"
